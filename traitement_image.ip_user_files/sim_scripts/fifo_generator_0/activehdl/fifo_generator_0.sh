...
#
# Script generated by Vivado on Fri Nov 15 10:52:17 +0100 2024
...
# script info
echo -e "fifo_generator_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/noliv/traitement_image/traitement_image.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
