...
HD_PWD='C:/Users/noliv/traitement_image/traitement_image.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memoire_cache.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memoire_cache.tcl
